...
from MySpider.items import ZhihuQuestionItem, ZhihuAnswerItem
...
class ZhihuSpider(scrapy.Spider):
    ...
    phone = '+8615855501216'  # 手机号
    password = '2502237702'  # 密码
    ...
    def parse_question(self, response):
        if "QuestionHeader-title" in response.text:
            ...
            item_loader.add_xpath(
                "content",
                "//*[@class='QuestionHeader-detail']/div/div/span/text()"
            )
            ...
            item_loader = ItemLoader(item=ZhihuQuestionItem(), response=response)
            item_loader.add_xpath(
                "title", "//*[@id='zh-question-title']/h2/a/text()|//*[@id='zh-question-title']/h2/span/text()")
    ...
    def login(self, response):
        ...
        fp = open('MySpider/spiders/zhihu.js')
        js = fp.read()
        fp.close()
    ...
    def check_login(self, response):
        ...
        print("登录成功")
        yield scrapy.Request(url=home_url, headers=headers)
